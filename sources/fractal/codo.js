...
CODO.prototype = {
    ...
    alphabetE: function(n) {
        var M = this.Mutation;
        var M1 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(331, 146), new Affine(577, 146), new Affine(350, 146));

        var M2 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(331, 480), new Affine(577, 480), new Affine(350, 480));

        var M3 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(331, 302), new Affine(577, 302), new Affine(350, 302));

        var M4 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(331, 146), new Affine(331, 480), new Affine(331, 245));

        var M5 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(281, 268), new Affine(434, 104), new Affine(577, 473));

        var P0 = new Affine(300, 400);
        var p1 = p2 = p3 = p4 = 0.25;
    ...
    animateE: function(n) {
        ...
        var timer = setInterval(function() {
            ...
            that.ctx.clearRect(0, 0, 1000, 1200);
            that.ctx.beginPath();
            for (var i = 0, l = result.length; i < l; i++) {
                that.ctx.rect(result[i][0], result[i][1], 1, 1);
            }
    ...
    alphabetX: function(n) {
        var M = this.Mutation;
        var M1 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(458, 296), new Affine(577, 480), new Affine(478, 319));

        var M2 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(458, 296), new Affine(577, 146), new Affine(478, 273));

        var M3 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(458, 296), new Affine(331, 146), new Affine(436, 273));

        var M4 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(458, 296), new Affine(331, 480), new Affine(436, 319));

        var M5 = M.image(new Affine(331, 146), new Affine(577, 146), new Affine(331, 480),
            new Affine(281, 268), new Affine(434, 104), new Affine(577, 480));
    ...
    heart: function(n) {
        var M = this.Mutation;
        var M1 = M.image(new Affine(280, 165), new Affine(669, 165), new Affine(476, 424),
            new Affine(280, 165), new Affine(476, 424), new Affine(314, 328));

        var M2 = M.image(new Affine(280, 165), new Affine(669, 165), new Affine(476, 424),
            new Affine(669, 165), new Affine(476, 424), new Affine(629, 328));

        var M3 = M.image(new Affine(280, 165), new Affine(669, 165), new Affine(476, 424),
            new Affine(280, 165), new Affine(476, 251), new Affine(379, 111));

        var M4 = M.image(new Affine(280, 165), new Affine(669, 165), new Affine(476, 424),
    ...
    animateHeart: function(n) {
        ...
        var M5 = M.image(new Affine(280, 165), new Affine(669, 165), new Affine(476, 424),
            new Affine(325, 112), new Affine(694, 214), new Affine(408, 406));
